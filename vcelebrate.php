...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/home3.webp" alt="Image">
                    <img style="margin-top: -343px;
                    margin-left: 42%;
                    width: 240px;" class="rounded-circle" alt="" src="img/vcelebrate.webp" data-holder-rendered="true">
                </div>
  ...
  <center><h3 style="font-family: cursive;
    ...
    font-size: 40px;
    margin-bottom: 20px;
    margin-top: 20px;">Cakes</h3></center>

    <center><h5 style="color:grey;">"The icing on the cake is when other people enjoy your vision and</br> support what you do."</h5></center>
...
<div class="container">
  <center><h3 style="font-family: cursive;
    ...
    font-size: 40px;
    margin-bottom: 20px;
    margin-top: 20px;">Events</h3></center>

    <center><h5 style="color:grey;">"The act of gathering as a family strengthens</br> the connection made long ago."</h5></center>
</div>
...
<div class="container">
  <center><h3 style="font-family: cursive;
    ...
    font-size: 40px;
    margin-bottom: 20px;
    margin-top: 20px;">Gifts</h3></center>

    <center><h5 style="color:grey;">"Some gifts are big. Others are small. But the ones come 
</br>from the heart are the best gifts of all"</h5></center>
</div>
