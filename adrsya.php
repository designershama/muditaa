...
<body>
 ...
 <!-- Carousel Start -->
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/home2.webp" alt="Image">
                    <img style="margin-top: -343px;
                    margin-left: 42%;
                    width: 240px;" class="rounded-circle" alt="" src="img/adrsya1.webp" data-holder-rendered="true">
                </div>
    ...
    error_reporting(0);
    $id=$_GET['id'];
    $selectquery = "select * from muditaa where cat='Adrsya' order by id asc" ;
